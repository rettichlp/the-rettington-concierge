...
public abstract class TabGameMenu<E> extends GameMenu {
    ...
    public TabGameMenu(Player player) {
        super(player);
    }
     ...
     */
    public abstract E[] elements(int tabIndex);
    ...
    public void builder(RegisteredInventory.@NonNull Builder registeredInventoryBuilder, int page, int tabIndex) {
        ...
        for (E element : elements(tabIndex)) {
    ...
    public void open(int tabIndex) {
        ...
        builder(registeredInventoryBuilder, 1, tabIndex);
    ...
    void addTabIcons(RegisteredInventory.Builder registeredInventoryBuilder) {
        for (int tabIndex = 0; tabIndex < 9; tabIndex++) {
            ...
            int finalI = tabIndex;
            registeredInventoryBuilder.item(tabIndex, itemStack, (clicker, _, _, _) -> open(isExistingTabItem ? finalI : this.currentTabIndex));
        }
    }
}
